...
export default defineConfig({
  ...
  transformHead({ pageData }) {
    ...
    const hostname = 'https://lzw.me/docs/opencodedocs'
  ...
  head: [
    ...
    ['meta', { name: 'keywords', content: '开源教程, OpenCode 开发文档, 编程教程, 开发者文档' }],
    ['meta', { property: 'og:site_name', content: 'OpenCode Docs' }],
  ...
  locales: {
    ...
    zh: {
      ...
      themeConfig: {
        nav: [
          { text: 'AI好站', link: 'https://chatgpt-sites.lzw.me' },
          { text: '免费视频下载', link: 'https://m3u8-downloader.lzw.me/portal/' },
          { text: 'ImageKit', link: 'https://imagekit.lzw.me' },
          { text: 'tools', link: 'https://tool.lzw.me' },
        ],
        docFooter: {
          prev: '上一页',
          next: '下一页'
