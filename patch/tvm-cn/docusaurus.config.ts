  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {href: 'https://github.com/hyperai/tvm-cn', label: 'GitHub', position: 'right'},
        {href: 'https://tool.lzw.me', label: '有趣工具箱', position: 'left'},
        {href: 'https://lzw.me/x/reference/', label: 'IT速查清单', position: 'left'},
